...
// Proto generation
//go:generate sh -c "protoc -I`go list -m -f \"{{.Dir}}\" github.com/mitchellh/protostructure` -I./3rdparty/proto/api-common-protos -Iproto --experimental_allow_proto3_optional --go-grpc_opt=module=github.com/hashicorp/vagrant-plugin-sdk/proto/vagrant_plugin_sdk --go-grpc_out=require_unimplemented_servers=false:proto/vagrant_plugin_sdk/ --go_opt=module=github.com/hashicorp/vagrant-plugin-sdk/proto/vagrant_plugin_sdk --go_out=proto/vagrant_plugin_sdk/ proto/vagrant_plugin_sdk/*.proto"
