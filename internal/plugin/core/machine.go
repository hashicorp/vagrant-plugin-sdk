...
func (t *targetMachineServer) SyncedFolders(
	...
	for _, folder := range syncedFolders {
		...
		f, err = t.Map(folder.Folder, (**vagrant_plugin_sdk.Target_Machine_SyncedFoldersResponse_FolderHash)(nil), argmapper.Typed(ctx))
		if err != nil {
			return nil, err
		}
		sf = append(sf, &vagrant_plugin_sdk.Target_Machine_SyncedFoldersResponse_MachineSyncedFolder{
			...
			Folder: f.(*vagrant_plugin_sdk.Target_Machine_SyncedFoldersResponse_FolderHash),
		})
	}
