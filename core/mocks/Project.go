...
func (_m *Project) Boxes() (core.BoxCollection, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (core.BoxCollection, error)); ok {
		return rf()
	}
...
func (_m *Project) DataDir() (*datadir.Project, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*datadir.Project, error)); ok {
		return rf()
	}
...
func (_m *Project) DefaultProvider(opts *core.DefaultProviderOptions) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(*core.DefaultProviderOptions) (string, error)); ok {
		return rf(opts)
	}
...
func (_m *Project) Host() (core.Host, error) {
	...
	var r0 core.Host
	var r1 error
	if rf, ok := ret.Get(0).(func() (core.Host, error)); ok {
		return rf()
	}
...
func (_m *Project) Target(name string, provider string) (core.Target, error) {
	...
	var r0 core.Target
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (core.Target, error)); ok {
...
func (_m *Project) TargetIndex() (core.TargetIndex, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (core.TargetIndex, error)); ok {
		return rf()
	}
