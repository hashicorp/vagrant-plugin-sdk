...
func (_m *TargetIndex) Delete(machine core.MachineEntry) error {
...
func (_m *TargetIndex) Get(uuid string) (core.MachineEntry, error) {
	ret := _m.Called(uuid)
...
func (_m *TargetIndex) Recover(entry core.MachineEntry) (core.MachineEntry, error) {
	ret := _m.Called(entry)
...
func (_m *TargetIndex) Release(entry core.MachineEntry) error {
	ret := _m.Called(entry)
...
func (_m *TargetIndex) Set(entry core.MachineEntry) (core.MachineEntry, error) {
	ret := _m.Called(entry)
