...
func (_m *Box) Compare(box core.Box) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(core.Box) (int, error)); ok {
		return rf(box)
	}
...
func (_m *Box) InUse(index core.TargetIndex) (bool, error) {
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(core.TargetIndex) (bool, error)); ok {
		return rf(index)
	}
...
func (_m *Box) Machines(index core.TargetIndex) ([]core.Machine, error) {
	...
	var r0 []core.Machine
	var r1 error
	if rf, ok := ret.Get(0).(func(core.TargetIndex) ([]core.Machine, error)); ok {
		return rf(index)
	}
...
func (_m *Box) Metadata() (core.BoxMetadata, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (core.BoxMetadata, error)); ok {
		return rf()
	}
...
func (_m *Box) UpdateInfo(version string) (bool, core.BoxMetadata, string, string, error) {
	...
	var r3 string
	var r4 error
	if rf, ok := ret.Get(0).(func(string) (bool, core.BoxMetadata, string, string, error)); ok {
		return rf(version)
	}
	if rf, ok := ret.Get(0).(func(string) bool); ok {
		r0 = rf(version)
...
type mockConstructorTestingTNewBox interface {
	mock.TestingT
	Cleanup(func())
}
