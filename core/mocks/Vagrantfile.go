...
func (_m *Vagrantfile) GetConfig(namespace string) (*component.ConfigData, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*component.ConfigData, error)); ok {
		return rf(namespace)
	}
...
func (_m *Vagrantfile) TargetConfig(name string, provider string, validateProvider bool) (core.Vagrantfile, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, bool) (core.Vagrantfile, error)); ok {
		return rf(name, provider, validateProvider)
	}
...
type mockConstructorTestingTNewVagrantfile interface {
	mock.TestingT
	Cleanup(func())
}
