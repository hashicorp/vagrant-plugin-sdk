...
func (_m *BoxCollection) Add(_a0 path.Path, name string, version string, metadataURL string, force bool, providers ...string) (core.Box, error) {
	...
	var r0 core.Box
	var r1 error
	if rf, ok := ret.Get(0).(func(path.Path, string, string, string, bool, ...string) (core.Box, error)); ok {
		return rf(_a0, name, version, metadataURL, force, providers...)
	}
...
func (_m *BoxCollection) Find(name string, version string, providers ...string) (core.Box, error) {
	...
	var r0 core.Box
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, ...string) (core.Box, error)); ok {
		return rf(name, version, providers...)
	}
...
type mockConstructorTestingTNewBoxCollection interface {
	mock.TestingT
	Cleanup(func())
}
